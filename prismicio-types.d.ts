...
export interface HeroSliceDefaultPrimary {
   ...
   * - **Placeholder**: Escape the Reality
...
export interface TextAndImageSliceDefaultPrimary {
  ...
  /**
   * Backgorund Image field in *TextAndImage → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.default.primary.backgorund_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface TextAndImageSliceImageOnLeftPrimary {
  ...
  /**
   * Backgorund Image field in *TextAndImage → Image on left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLeft.primary.backgorund_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  backgorund_image: prismic.ImageField<never>;
