...
const Hero: FC<HeroProps> = ({ slice }) => {
  return (
    <Bounded
      ...
      <div className="flex relative w-full felx-col items-center justify-between ~gap-2/4 lg:flex-row">
        <div className="max-w-[45ch] font-semibold ~text-lg/xl">
          <PrismicRichText field={slice.primary.body} />
        </div>
        <ButtonLink field={slice.primary.button} icon="skateboard" size='lg' className='z-20 mt-2 block button-cutout'>{slice.primary.button.text}</ButtonLink>
